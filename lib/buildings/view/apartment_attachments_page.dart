// lib/buildings/view/apartment_attachments_page.dart
import 'dart:io';
...
import 'package:local_storage_api/local_storage_api.dart'
    show Apartment, ApartmentAttachment;
...
class ApartmentAttachmentsPage extends StatefulWidget {
  final Apartment apartment;
  final bool canManage;

  const ApartmentAttachmentsPage({
    super.key,
  ...
  static Route<void> route(
    ...
    return MaterialPageRoute(
      builder: (ctx) => BlocProvider.value(
        value: cubit,
        child: ApartmentAttachmentsPage(
          apartment: apartment,
          canManage: canManage,
        ),
      ),
  ...
  @override
  State<ApartmentAttachmentsPage> createState() =>
      _ApartmentAttachmentsPageState();
}

class _ApartmentAttachmentsPageState extends State<ApartmentAttachmentsPage> {
  ...
  Future<void> _startUploadProcess() async {
    ...
    for (int i = 0; i < result.files.length; i++) {
      ...
      if (file.path != null) {
        try {
          await cubit.attachFileToApartmentGallery(
          ...
          child: isUploading
              ...
              : BlocBuilder<BuildingsCubit, BuildingsState>(
                  builder: (context, state) {
                    final attachments =
                        state.apartmentAttachmentsMap[widget.apartment.id] ??
                        [];
                            ...
                            Positioned(
                              ...
                              child: CircleAvatar(
                                ...
                                child: IconButton(
                                  ...
                                  onPressed: () => context
                                      .read<BuildingsCubit>()
                                      .deleteApartmentAttachment(att.id),
                                ),
                              ),
                            ),
                          if (isImage)
