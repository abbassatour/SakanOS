          ...
          children: [
            Container(
              ...
              child: Column(
                children: [
                  SwitchListTile(
                    title: Text(
                      l10n.contractFinDollarToggleTitle,
                      style: TextStyle(
                    ...
                    subtitle: isHistoricalContract
                        ? Text(
                            l10n.contractFinDollarHistSubtitle,
                            style: const TextStyle(color: Colors.green),
                          )
                        : (currentDollarRate != null
                              ? Text(
                                  l10n.contractFinDollarCurrentRate(
                              ...
                              : Text(
                                  l10n.contractFinDollarMissingRate,
                    ...
                    Padding(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          labelText: l10n.contractFinHistDollarLabel,
                            ...
                            TextField(
                              ...
                              decoration: InputDecoration(
                                labelText: isDollarContract
                                    ? l10n.contractFinDownPaymentUsd
                                    : l10n.contractFinDownPaymentSyp,
                        ...
                        child: Column(
                          ...
                          children: [
                            TextField(
                              ...
                              decoration: InputDecoration(
                                labelText: isDollarContract
                                    ? l10n.contractFinMonthlyUsd
                                    : l10n.contractFinMonthlySyp,
                                border: const OutlineInputBorder(),
                                filled: true,
                                fillColor: Colors.white,
                                prefixIcon: Icon(
            ...
            if (isAllocated) ...[
                ...
                children: [
                  Expanded(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        labelText: l10n.contractFinTotalAreaLabel,
                        border: const OutlineInputBorder(),
                        filled: true,
                  ...
                  Expanded(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        labelText: l10n.contractFinDurationMonthsLabel,
                        border: const OutlineInputBorder(),
                      ),
                      keyboardType: TextInputType.number,
                    ),
                  ...
                  Expanded(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        labelText: l10n.contractFinDurationPctLabel,
                        border: const OutlineInputBorder(),
                        filled: true,
              ...
              Container(
                ...
                child: Text(
                  l10n.contractFinUnallocatedNote,
              ...
              child: ElevatedButton.icon(
                ...
                label: Text(
                  isHistoricalContract
                      ? l10n.contractFinCalcHistoricalBtn
                      : l10n.contractFinCalcTodayBtn,
            ...
            TextField(
              ...
              decoration: InputDecoration(
                labelText: isHistoricalContract
                    ? l10n.contractFinPriceFieldHistLabel
                    : l10n.contractFinPriceFieldAutoLabel,
                border: const OutlineInputBorder(),
                filled: true,
