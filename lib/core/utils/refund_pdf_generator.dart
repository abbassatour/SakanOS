      ...
      return pw.Container(
        ...
        child: pw.Column(
          ...
          children:[
            ...
            pw.Center(child: pw.Text('سند استرداد نقدي - $copyType', style: pw.TextStyle(font: arabicBoldFont, fontSize: 8, color: accentColor))),
            ...
            pw.Text('المستلم: ${client.name}', style: pw.TextStyle(font: arabicBoldFont, fontSize: 9, color: primaryColor)),
              ...
              children:[
                ...
                pw.Expanded(
                  ...
                  child: pw.Container(
                    ...
                    decoration: pw.BoxDecoration(color: PdfColors.red50, border: pw.Border.all(color: accentColor, width: 0.5), borderRadius: pw.BorderRadius.circular(4)),
                    child: pw.Column(children:[
                      ...
                      if (penaltyPercentage != null && penaltyPercentage != 0)
                        _buildFinancialRow(font: arabicFont, boldFont: arabicBoldFont, title: 'غرامة تأخير:', value: '%${penaltyPercentage.abs().toStringAsFixed(1)}', valueColor: PdfColors.red),
                      
                      if (meterPriceAfterPenalty != null)
                        _buildFinancialRow(font: arabicFont, boldFont: arabicBoldFont, title: 'السعر بعد الغرامة:', value: '${_fmtMoney(meterPriceAfterPenalty)} ل.س', valueColor: PdfColors.red900),
                      
                      _buildFinancialRow(font: arabicFont, boldFont: arabicBoldFont, title: 'المبلغ المسترد:', value: '${_fmtMoney(absAmountPaid)} ل.س', isTotal: true, primaryColor: PdfColors.red900),
                      ...
                      _buildFinancialRow(font: arabicFont, boldFont: arabicBoldFont, title: 'الأمتار المخصومة:', value: '-${_fmtMeters(absConvertedMeters)} م2', isTotal: true, valueColor: PdfColors.red900),
                    ])
                  ),
                ),
              ],
            ...
            pw.Row(mainAxisAlignment: pw.MainAxisAlignment.spaceBetween, crossAxisAlignment: pw.CrossAxisAlignment.end, children:[
                pw.Column(children:[pw.Text('توقيع الشركة', style: pw.TextStyle(font: arabicBoldFont, fontSize: 8, color: primaryColor)), pw.SizedBox(height: 20)]),
                pw.Column(children:[pw.Text('توقيع المستلم', style: pw.TextStyle(font: arabicBoldFont, fontSize: 8, color: PdfColors.red800)), pw.SizedBox(height: 20)]),
            ]),
          ],
        ),
      );
