...
class MaterialsTrendPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => MaterialsTrendCubit(context.read<ErpRepository>())..fetchData(),
...
class _MaterialsTrendView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFFF4F6FA), // خلفية رمادية مزرقة مريحة للعين
      appBar: AppBar(
        backgroundColor: ChartColors.primary,
        title: const Text('غرفة التحليل المالي والتسعير', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white, letterSpacing: 0.5)),
        centerTitle: true,
      ...
      body: BlocBuilder<MaterialsTrendCubit, MaterialsTrendState>(
        builder: (context, state) {
            ...
            return const Center(
              child: Column(
                ...
                children:[
                  ...
                  SizedBox(height: 16),
                  Text('جاري معالجة السجلات التاريخية...', style: TextStyle(color: Colors.blueGrey, fontWeight: FontWeight.bold)),
                ],
              ),
            );
          }
          ...
          if (state.status == MaterialsTrendStatus.failure) {
            return Center(child: Text('خطأ في النظام: ${state.errorMessage}', style: const TextStyle(color: Colors.red)));
          }

          // 🌟 3. التحقق الاحترافي من خلو البيانات في الفترة الزمنية المحددة
          final bool isAllEmpty = state.ironTrend.values.every((v) => v == 0) && 
            ...
            child: Column(
              ...
              children:[
                  ...
                  child: Row(
                    children:[
                      Container(
                        ...
                        child: Icon(Icons.troubleshoot, color: Colors.indigo.shade700, size: 32),
                      ),
                      ...
                      const Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children:[
                            Text('تحليل مكونات التكلفة الخام (Raw Material Analytics)', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: ChartColors.titleColor)),
                            SizedBox(height: 6),
                            Text('تتبع التغيرات التاريخية لكل مادة بشكل مستقل. استخدم شريط الزمن أدناه لمعرفة المسبب الحقيقي لتضخم تكاليف البناء في أي فترة.', style: TextStyle(fontSize: 13, color: ChartColors.axisLabel, height: 1.5)),
                          ],
                        ),
                      ),
                    ],
                ...
                SectionHeader(
                  ...
                  onPrevious: context.read<MaterialsTrendCubit>().navigatePrevious,
                  onNext: context.read<MaterialsTrendCubit>().navigateNext,
                  onFilterChanged: context.read<MaterialsTrendCubit>().changeTimeFilter,
                ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children:[
                          ...
                          Text('لا توجد بيانات مسجلة لأسعار المواد في هذه الفترة.', style: TextStyle(color: Colors.grey.shade600, fontSize: 16, fontWeight: FontWeight.bold)),
                          const SizedBox(height: 8),
                          Text('قم بتغيير الفلتر الزمني أو العودة لفترة سابقة.', style: TextStyle(color: Colors.grey.shade400, fontSize: 13)),
                        ],
                      ),
                    ),
                  )
                        ...
                        children:[
                          SizedBox(
                            ...
                            child: TrendLineChart(
                              ...
                              description: 'يعرض التغير الزمني لمتوسط سعر الكيلوغرام الواحد من الحديد المبروم.',
                          ...
                          SizedBox(
                            ...
                            child: TrendLineChart(
                              ...
                              description: 'يعرض التغير الزمني لمتوسط سعر كيس الإسمنت البورتلاندي.',
                          ...
                          SizedBox(
                            ...
                            child: TrendLineChart(
                              ...
                              description: 'يعرض التغير الزمني لمتوسط سعر البلوكة الواحدة سماكة 15 سم.',
                          ...
                          SizedBox(
                            ...
                            child: TrendLineChart(
                              ...
                              description: 'يعرض التغير الزمني لمتوسط تكلفة الكوفراج وصب المتر المكعب الواحد.',
                          ...
                          SizedBox(
                            ...
                            child: TrendLineChart(
                              ...
                              description: 'يعرض التغير الزمني لمتوسط سعر المتر المكعب من الرمل والبحص (المواد الحصوية).',
                          ...
                          SizedBox(
                            ...
                            child: TrendLineChart(
                              ...
                              description: 'يعرض التغير الزمني لمتوسط يومية العامل العادي.',
