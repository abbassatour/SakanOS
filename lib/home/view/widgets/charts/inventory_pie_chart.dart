                  ...
                  child: Stack(
                    ...
                    children:[
                      ...
                      Column(
                        ...
                        children:[
                          Text('$total', style: const TextStyle(fontSize: 26, fontWeight: FontWeight.bold, color: ChartColors.titleColor)),
                          const Text('وحدة عقارية', style: TextStyle(fontSize: 11, color: ChartColors.axisLabel)),
                        ],
                      ),
                      PieChart(
                        PieChartData(
                  ...
                  children: data.entries.map((e) {
                    ...
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: _getColorForStatus(e.key).withOpacity(0.3)),
                      ),
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
                        children:[
                          Icon(_getIconForStatus(e.key), size: 16, color: _getColorForStatus(e.key)),
                          const SizedBox(width: 6),
                          Text(
                            '${e.key} (${pct.toStringAsFixed(1)}%)',
                            style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: _getColorForStatus(e.key)),
                          ),
                        ],
                      ),
                    );
