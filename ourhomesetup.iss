...
; أيقونة ملف التثبيت
SetupIconFile=C:\Users\DELL\Desktop\our_home_erp_app\windows\runner\resources\app_icon.ico

; 🌟 [التعديل الأول والأهم]: إجبار المثبت على طلب صلاحيات المسؤول (Run as Administrator)
PrivilegesRequired=admin

; 🌟 [التعديل الثاني]: استخدام x64 لضمان استقرار التثبيت على ويندوز 10
...
[Run]
; 🌟 [التعديل الثالث]: استخدام /passive بدلاً من /quiet لكي يظهر شريط تقدم التثبيت ولا يعلق النظام
Filename: "{tmp}\vc_redist.x64.exe"; Parameters: "/passive /norestart"; StatusMsg: "Installing Microsoft Visual C++ Redistributable (Required)..."; Flags: waituntilterminated
